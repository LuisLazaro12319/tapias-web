...
export const CLAVE_ACENTO = "tapias.acento";

/** Colores sugeridos. El primero (Dorado) es el default del sitio. */
...
/** Vuelve al color por defecto del sitio (dorado de globals.css, claro y oscuro). */
