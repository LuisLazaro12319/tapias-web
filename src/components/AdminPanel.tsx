            ...
            <div className="space-y-5">
              <div className="rounded-xl border border-borde bg-background p-6">
                ...
                <div className="grid gap-4">
                  ...
                  <Campo label="Título" valor="Moda oversize y urbana directo de fábrica" />
              ...
              <div className="rounded-xl border border-borde bg-background p-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <Campo label="Etiqueta de arriba" valor="Estilo, comodidad y actitud" />
                  ...
                  <div className="sm:col-span-2">
                    <Campo label="Texto" area valor={`Moda oversize y urbana al mejor precio, calidad y estilo. Accedé a precios de fábrica desde solo ${MINIMO_MAYORISTA} prendas.`} />
                  </div>
                </div>
                <p className="mt-3 rounded-lg bg-acento/10 px-3 py-2 text-[11px] text-tenue">
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-xl border border-borde bg-background p-6">
                ...
                <div className="flex gap-3">
                  <span className="cursor-not-allowed rounded-none border border-borde bg-superficie px-4 py-2.5 text-sm font-medium text-tenue">☀️ Claro</span>
                  <span className="cursor-not-allowed rounded-none border-2 border-acento bg-superficie px-4 py-2.5 text-sm font-semibold">🌙 Oscuro</span>
                </div>
                <Bloqueado />
              </div>
            </div>
          ...
          {vista === "config" && (
            <div className="rounded-xl border border-borde bg-background p-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Campo label="Rubro" valor="Indumentaria masculina · Moda oversize & urbana" />
