...
export function TemaToggle() {
  ...
  // Tapias arranca en oscuro por defecto: sin atributo (o "dark") = oscuro,
  // solo "light" es modo día.
  /* eslint-disable react-hooks/set-state-in-effect */
  useEffect(() => {
    setOscuro(document.documentElement.getAttribute("data-theme") !== "light");
    setListo(true);
  }, []);
  ...
  function alternar() {
    ...
    try {
      localStorage.setItem("tapias.tema", nuevo ? "dark" : "light");
    } catch {}
  }
